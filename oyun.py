import play
import math
#play.new_image(image="C:\Users\Windows10\Desktop\Araba\-aa.jpg", size=100, transparency=5)
...
async def repeat():
    ...
    if play.key_is_pressed("a"):
        ...
        while top[0].y < -20:
            ...
            orta_top.color=play.random_color()
            yeni_top.color=orta_top.color
            top = [play.new_circle(y = -250 , radius = 15),play.new_text(words = str(sayi),y = -250, font_size= 25 , color = "white")]
            top[0].color=orta_top.color
